...
*** Benchmarks
    ...
    #+BEGIN_SRC sh
    2026-02-22T19:39:21-05:00
    Running ./build/orderbook_benchmark
    Run on (16 X 3767.42 MHz CPU s)
    CPU Caches:
      L1 Data 32 KiB (x8)
      L1 Instruction 32 KiB (x8)
      L2 Unified 512 KiB (x8)
      L3 Unified 32768 KiB (x1)
    Load Average: 1.34, 0.67, 0.51
    ----------------------------------------------------------------------------
    Benchmark                                  Time             CPU   Iterations
    ----------------------------------------------------------------------------
    PreppedOrdersFixture/AddLimit            264 ns          264 ns      2803326
    PreppedOrderBookFixture/AddMarket        151 ns          150 ns      5250030
    #+END_SRC
** Resources
