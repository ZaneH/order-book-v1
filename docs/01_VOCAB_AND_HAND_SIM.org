...
- cross: an incoming order "crosses" the best bid/ask price allowing the engine to immediately match
  - incoming bid_price >​= best_ask
  - incoming ask_price <​= best_bid
- maker price: execution price of a trade, equal to the limit price of the resting order
